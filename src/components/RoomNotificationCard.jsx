// src/components/RoomNotificationCard.jsx
...
const getDefaultTemplate = (roomName, templateType) => {
  ...
  const templates = {
    checkIn: {
      title: `${pensionName} ${roomName} 입실안내`,
      content: `[${pensionName}]
안녕하세요 {고객명}님!
...
문의: {전화번호}`
    ...
    checkOut: {
      title: `${pensionName} ${roomName} 퇴실안내`,
      content: `[${pensionName}]
{고객명}님, 즐거운 시간 보내셨나요?
...
문의: {전화번호}`
    ...
    confirmation: {
      title: `${pensionName} ${roomName} 예약확정`,
      content: `[${pensionName}]
{고객명}님, 예약이 확정되었습니다.
...
문의: {전화번호}`
    ...
    cancellation: {
      title: `${pensionName} ${roomName} 예약취소`,
      content: `[${pensionName}]
{고객명}님, 예약이 취소되었습니다.
...
const RoomNotificationCard = ({ roomName, settings, onUpdate, onSave, loading }) => {
  ...
  // 저장
  const handleSave = () => {
    onUpdate(roomName, localSettings);
    if (onSave) {
      onSave(roomName);
    }
  };
          ...
          <div className="template-editor-section">
            <div className="editor-header">
              <input
                ...
                value={localSettings.templates[activeTemplate].title}
            ...
            <div className="editor-content">
              <div className="editor-column">
                ...
                <textarea
                  ...
                  value={localSettings.templates[activeTemplate].content}
              ...
              <div className="preview-column">
                ...
                <div className="template-preview">
                  <div className="preview-title">
                    {localSettings.templates[activeTemplate].title}
                  </div>
                  <div className="preview-content">
                    {getPreviewContent(localSettings.templates[activeTemplate].content)}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="auto-send-item">
                ...
                <div className="time-setting">
                  ...
                  <input
                    ...
                    onChange={(e) => handleAutoSendChange('checkInHoursBefore', parseInt(e.target.value))}
              ...
              <div className="auto-send-item">
                ...
                <div className="time-setting">
                  ...
                  <input
                    ...
                    onChange={(e) => handleAutoSendChange('checkOutHoursBefore', parseInt(e.target.value))}
...
export default RoomNotificationCard;