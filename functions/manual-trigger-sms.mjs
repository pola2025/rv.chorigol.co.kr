...
async function main() {
  ...
  if (!type || !['checkIn', 'checkOut'].includes(type)) {
    console.log('\n사용법:');
    console.log('  node manual-trigger-sms.mjs checkIn   # 입실 안내 발송');
    console.log('  node manual-trigger-sms.mjs checkOut  # 퇴실 안내 발송');
    console.log('\n예시:');
    console.log('  node manual-trigger-sms.mjs checkIn');
    return;
  }
